class HomeCarrousel {
      constructor() {
        ...
        this.thumbs.forEach(thumb => {
          thumb.addEventListener('click', event => this.thumbnailClickHandler(event));
        });
      ...
      mostrarSlide(n) {
        ...
        tituloNoticia.innerText = noticias[this.indiceSlide].titulo;
      ...
      cambiarSlide(n) {
        this.mostrarSlide(this.indiceSlide += n);
      }
