...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='all' href='../../../styles/misDatosStyles.css'>
...
<body>
    ...
    <main>
        ...
        <section class="seccion_principal">
            ...
            <section class="seccion_mis_datos">

                <div class="div_encabezado_mis_datos"> 

                    <h1 class="titulo_principal">
                        Tus datos
                    </h1>
        
                    <button class="boton_cambiar_contrasena">
                        <a href="cambio_contraseña.html">
                            cambiar contrasena
                        </a>
                    </button>
                ...
                <section class="seccion_datos_usuario">

                    <dl class="datos_generales_usuario_izquierda">
                        <dt>Nombre:</dt> 
                            <dd>nombre_usuario</dd>
                        <dt>Apellido:</dt> 
                            <dd>apellido_usuario</dd>
                        <dt>Fecha Nac:</dt> 
                            <dd>dd/mm/aaaa</dd>
                        <dt>Email:</dt> 
                            <dd>email_usuario</dd>
                        <dt>Teléfono:</dt> 
                            <dd>teléfono_usuario</dd>
                    </dl>
                    
                    <dl class="datos_generales_usuario_derecha">
                        <dt>Obra social:</dt> 
                            <dd>obra_social_usuario</dd>
                        <dt>Número afiliado:</dt> 
                            <dd>num_afi_usuario</dd>
                        <dt>Documento:</dt> 
                            <dd>documento_usuario</dd>
                        <dt>Tipo:</dt> 
                            <dd>tipo_doc_usuario</dd>
                        <dt>Provincia:</dt> 
                            <dd>provincia_usuario</dd>
                        <dt>Localidad:</dt> 
                            <dd>localidad_usuario</dd>
                        <dt>Calle:</dt> 
                            <dd>calle_usuario</dd>
                        <dt>N°:</dt> 
                            <dd>numero_usuario</dd>
                        <dt>Piso:</dt> 
                            <dd>piso_usuario</dd>
                        <dt>Depto:</dt> 
                            <dd>depto_usuario</dd>
