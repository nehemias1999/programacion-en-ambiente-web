...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='all' href='../../styles/resultadosStyles.css'>
    ...
    <main>
        ...
        <section class="seccion_principal">
            ...
            <section class="seccion_resultados">
                ...
                <div class="div_nombre_columnas">

                    <h3 class="titulo_nombre_columna">
                        Fecha realizado
                    </h3>
                ...
                <div class="div_scrollbar">
                    ...
                    <div class="div_contenido">
                        ...
                        <ul class="lista_resultados">
                            ...
                            <li class="elemento_resultado">
    
                                <article class="articulo_resultado">
                                
                                    <p class="parrafo_fecha_realizado">
                                        dd/mm/aaaa
                                    </p>
    
                                    <p class="parrafo_estado">
                                        Estado
                                    </p>
    
                                    <p class="parrafo_tipo_examen">
                                        Tipo examen
                                    </p>
    
                                    <p class="parrafo_solicitud">
                                        Solicitud
                                    </p>
    
                                    <button class="boton_enlace_resultado">
                                        <a href="">
                                            PDF
                                        </a>
                                    </button>
